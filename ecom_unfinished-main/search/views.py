...
# def price_range_list_view(request):
#     low_range = request.GET.get('lower_range')
#     top_range = request.GET.get('top_range')
#     if low_range == '':
#         low_range = 0
#     qs = Product.objects.filter(price__gte=low_range, price__lte=top_range)
#     print(qs)
#     context = {
#         'low_range': low_range,
#         'top_range': top_range,
#         'product_list': qs
#     }
#     return render(request, 'search/price_range_list.html', context)
